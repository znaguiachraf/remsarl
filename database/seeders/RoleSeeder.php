...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'View Tasks', 'slug' => 'task.view', 'module' => 'tasks'],
            ['name' => 'Create Tasks', 'slug' => 'task.create', 'module' => 'tasks'],
            ['name' => 'Assign Tasks', 'slug' => 'task.assign', 'module' => 'tasks'],
            ['name' => 'Complete Tasks', 'slug' => 'task.complete', 'module' => 'tasks'],
            ['name' => 'Delete Tasks', 'slug' => 'task.delete', 'module' => 'tasks'],
            ...
            ['name' => 'View Purchase Orders', 'slug' => 'purchase.view', 'module' => 'purchase'],
            ['name' => 'Create Purchase Orders', 'slug' => 'purchase.create', 'module' => 'purchase'],
            ['name' => 'Update Purchase Orders', 'slug' => 'purchase.update', 'module' => 'purchase'],
            ['name' => 'Receive Purchase Orders', 'slug' => 'purchase.receive', 'module' => 'purchase'],
        ...
        $roles = [
            ...
            [
                ...
                'level' => 60,
                'permissions' => Permission::whereIn('module', ['pos', 'tasks', 'payments', 'orders', 'products', 'stock', 'sales', 'expenses', 'suppliers', 'purchase', 'hr', 'logs'])->pluck('id')->toArray(),
            ],
            [
                'name' => 'Member',
                'slug' => 'member',
                ...
                'level' => 40,
                'permissions' => Permission::whereIn('slug', ['projects.view', 'pos.access', 'tasks.access', 'task.view', 'task.complete', 'product.view', 'stock.view', 'stock.history', 'sale.view', 'sale.pay', 'expense.view', 'expense.create', 'payment.view'])->pluck('id')->toArray(),
            ],
            [
                'name' => 'Viewer',
                'slug' => 'viewer',
