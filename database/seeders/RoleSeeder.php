    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            [
                ...
                'level' => 40,
                'permissions' => Permission::whereIn('slug', ['projects.view', 'pos.access', 'tasks.access', 'product.view', 'stock.access', 'sales.access', 'expense.view', 'expense.create', 'payment.view'])->pluck('id')->toArray(),
            ],
            [
                'name' => 'Viewer',
                'slug' => 'viewer',
