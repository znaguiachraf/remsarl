...
export default function PurchaseCreate({ project, suppliers, products }) {
    ...
    const handleSubmit = (e) => {
        ...
        form.post(route('projects.modules.purchase.store', project.id), {
            preserveScroll: true,
        });
    };
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 text-sm text-gray-500">Create a purchase order</p>
                        </div>
                    </div>
                </div>
            }
        >
            <Head title={`${project?.name} - New Purchase Order`} />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end gap-2">
                    <Link href={route('projects.modules.purchase.index', project.id)}>
