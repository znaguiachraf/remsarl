...
export const IconCalendar = ({ className = '' }) => (
    <svg className={`${iconClass} ${className}`.trim()} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const IconSwatch = ({ className = '' }) => (
    <svg className={`${iconClass} ${className}`.trim()} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const IconCheckSquare = ({ className = '' }) => (
    <svg className={`${iconClass} ${className}`.trim()} fill="none" stroke="currentColor" viewBox="0 0 24 24">
